...
#define FRAME_HEADER		0xAA // Byte đầu tiên của khung dữ liệu, dùng để đồng bộ hóa
#define FRAME_MAX_PAYLOAD	8 // Số byte dữ liệu tối đa trong khung, không bao gồm header, cmd, len
#define FRAME_MAX_DATA       8 // Kích thước mảng data trong frame_t, phải >= FRAME_MAX_PAYLOAD
